...
public class TestSuite {
    ...
    class getSolutionsTests {
        ...
        void shouldCalculateCorrectSolutions_whenEquationHasRealSolutions() {
            ...
            Assertions.assertEquals("5.000", answers1.root1());
            Assertions.assertEquals("5.000", answers1.root2());

            QuadraticSolver.QuadraticRoots answers2 = QuadraticSolver.getSolutions(6.0, -13.0, 6.0);
            Assertions.assertEquals("1.500", answers2.root1());
            Assertions.assertEquals("0.667", answers2.root2());
        }
        ...
        void shouldCalculateCorrectSolutions_whenEquationHasComplexSolutions() {
            ...
            Assertions.assertEquals("-2.0 + i2.000/2.0", answers.root1());
            Assertions.assertEquals("-2.0 - i2.000/2.0", answers.root2());
        }
